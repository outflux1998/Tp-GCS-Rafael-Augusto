...
def get_config():
    ...
    for file in os.listdir('/Users/rafael/Documents/GitHub/PUC-GCES-PY/src/yamls'):
        filepath = os.path.join('/Users/rafael/Documents/GitHub/PUC-GCES-PY/src/yamls', file)
